...
echo "asymmetric low"
python3 measurement.py ../cfg/asymmetric_low.json ../results/low/asymmetric/mix123/ -n 1 2 3
...
python3 measurement.py ../cfg/symmetric_low.json ../results/low/symmetric/mix123/ -n 1 2 3
...
python3 measurement.py ../cfg/asymmetric_medium.json ../results/medium/asymmetric/mix123/ -n 1 2 3
...
python3 measurement.py ../cfg/symmetric_medium.json ../results/medium/symmetric/mix123/ -n 1 2 3
...
python3 measurement.py ../cfg/asymmetric_high.json ../results/high/asymmetric/mix123/ -n 1 2 3
...
python3 measurement.py ../cfg/symmetric_high.json ../results/high/symmetric/mix123/ -n 1 2 3
